...
namespace RectangularParallelepiped
{
    internal class Box
    {
        ...
        public double CalculateSurfaceArea() => this.CalculateLateralSurfaceArea() + 2 * this.width * this.length;

        public double CalculateLateralSurfaceArea() => 2 * this.width * this.height + 2 * this.length * this.height;

...
namespace ValidatingPerson
{
    internal class Person
    {
        ...
        public Person(string firstName, string lastName, int age, double salary)
        {
            ...
            if (salary < MinSalary) throw new ArgumentException($"Salary cannot be less than {MinSalary} euros");
        ...
        {
            return $"{this.FirstName} {this.LastName} get {this.Salary:f2} euros.";
        }
    }
}

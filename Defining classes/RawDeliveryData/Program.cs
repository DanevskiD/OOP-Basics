        ...
        static void Main(string[] args)
        {
            ...
            switch (type)
            {
                case "fragile":
                    /*
                     * var fragile = cars
                        .Where(x => (x.CarTyres[0].Pressure < 1) ||
                                    (x.CarTyres[1].Pressure < 1) ||
                                    (x.CarTyres[2].Pressure < 1) ||
                                    (x.CarTyres[3].Pressure < 1))
                    ...
                    */
                    ...
                    var fragile = cars
                        .Where(x=>x.CarTyres.Any(t => t.Pressure <1))
                        .Select(y => y.Model.Name).ToList();
                    Console.WriteLine(string.Join("\n", fragile));
                    break;
